...
## 02. Movement- 
- for this prompt i created an interactive piece where lines move and change color based on the mouses position. I found learning about the mouseX and mouseY function really facinating to play around with. The end product being a lively and dynamic artpiece, that users can create unique patterns with.
